...
#include "coarseupdatevariable.h"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    mxArray *U_C, *BDRY, *fVals, *OB, *U_C_new, *U_F_new, *UF, *WIND, *W, *finewind, *uNEW, *UFINEMIN, *Uk, *FW, *orig,*THETA;;
    double *U, *BC, *F, *ucoarse,*ufine, *Ufine, *obs,  *wind, *w, *fw, *fwind, *UNEW, *UFM, *UK, *ORIG, *theta;
    double h,H,C, T;
   ...
   int k,c;
    ...
    for (int a=1; a<=paraiter; a++){
        ...
        //Fine sweeps with new effect R computed ///
            ...
            U=coarseupdatevariable(ORIG, U, UFM, UK, F,BC,obs,N,K,0,0,wind, fwind, sweepiter,theta);

            int p;
            for (p=1;p<K;p++)
            {
                U=coarseupdatevariable(ORIG, U,UFM, UK, F,BC,obs,N,K,p,0,wind, fwind, sweepiter,theta);
                U=coarseupdatevariable(ORIG, U,UFM, UK, F,BC,obs,N,K,0,p,wind, fwind, sweepiter,theta);
